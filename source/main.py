...
from environments.Road_env import Road
from brains.RL_brains import MC
from brains.RL_brains import QLearningTable
from brains.RL_brains import SarsaTable
from brains.RL_brains import ExpectedSarsa
from brains.RL_brains import SarsaLambdaTable
from brains.RL_brains import DP

from brains.DQN_pytorch import Agent
...
def display_results(agent, method_used_to_plot, returns_to_plot, smoothing_window, threshold_success,
    ...
    plt.figure()
    plt.hist(returns_to_plot, density=True, bins=100)
...
if __name__ == "__main__":
    ...
    with open('environments/Road_env_configuration.json', 'w') as outfile:
    ...
    method_used = "simple_dqn_pytorch"  # unstable
    ...
    display_learning_results = True  # only used for training_once
